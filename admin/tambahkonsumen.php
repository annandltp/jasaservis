	...
	<!-- start: Header -->
		...
		<div class="row-fluid sortable">		
			...
			<div class="box-content">
			  	<form class="form-horizontal" action="../aksi/proses.php?kirimkonsumen" method="post">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nm_konsumen">
					    </div>
					  </div><br>
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="submit" name="kirimkonsumen" class="btn btn-sm btn-info" value="tambah">
