...
<!-- 		 
		<div class="clearfix">
                            <button class="width-35 pull-right btn btn-sm btn-primary" onclick="location.href='tambahservis.php'">
			  ...
			  <div class="row-fluid sortable">
					<div class="box span12">
						<div class="box-header">
							<h2><i class="halflings-icon align-justify"></i><span class="break"></span>Table Data Servis </h2>
							<div class="box-icon">
						...
						<div class="box-content">
						    ...
						    <thead>
						      <tr>
						        ...
						        <th><font size="2">No.Tlpn</th>
						        <th><font size="2">Kerusakan</th>
						        <!-- <th><font size="2">Kelengkapan</th> -->
						        <th><font size="2">Tgl.Trima</th>
						        <th><font size="2">Penerima</th>
						        <th><font size="2">Teknisi</th>
						        <!-- <th><font size="2">Kondisi</th> -->
						        <th><font size="2">Tgl.Ambil</th>
						        <th><font size="2">QTY</th>
						        <th><font size="2">Jumlah</th>
						    ...
						    while ($result = $data->fetch_assoc()){
						      ...
						      <tr>
						        ...
						        <td><font size="2"><?php echo $result ['no']; ?></td>
						        <td><font size="2"><?php echo $result ['nmbarang'] ; ?></td>
						        <td><font size="2"><?php echo $result ['nmpemilik'] ; ?></td>
						        <td><font size="2"><?php echo $result ['alamat'] ; ?></td>
						        <td><font size="2"><?php echo $result ['tlpn'] ; ?></td>
						        <td><font size="2"><?php echo $result ['kerusakan'] ; ?></td>
						        <!-- <td><font size="2"><?php echo $result ['kelengkapan'] ; ?></td> -->
						        <td><font size="2"><?php echo $result ['tglditerima'] ; ?></td>
						        <td><font size="2"><?php echo $result ['penerimabarang'] ; ?></td>
						        <td><font size="2"><?php echo $result ['teknisi'] ; ?></td>
						        <!-- <td><font size="2"><?php echo $result ['kondisibrg'] ; ?></td> -->
						        <td><font size="2"><?php echo $result ['tglambil'] ; ?></td>
						        <td><font size="2"><?php echo $result ['qty'] ; ?></td>
						        <td><font size="2"><?php echo $result ['biaya'] ; ?></td>
