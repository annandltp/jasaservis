		...
		<div class="row-fluid sortable">		
				<div class="box span6">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Edit Data Konsumen</h2>
						<div class="box-icon">
			...
			<div class="box-content">
			  	<form class="form-horizontal" action="../aksi/konsumen_update.php?updatekonsumen" method="post">
				  <div class="form-group">
					    <label class="control-label col-sm-2" for="id_konsumen">No :</label>
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="id_konsumen" value="<?php echo $row ['0']; ?>" readonly>
					    </div>
					  </div><br>
					 
					 <div class="form-group">
					    <label class="control-label col-sm-2" for="kd_konsumen">Kode Konsumen :</label>
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kd_konsumen" value="<?php echo $row ['1']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nm_konsumen" value="<?php echo $row ['2']; ?>" required>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="telepon" value="<?php echo $row ['3']; ?>" required>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="alamat" value="<?php echo $row ['4']; ?>" required>
					    </div>
					  </div><br>
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="submit" name="updatekonsumen" class="btn btn-sm btn-info" value="Ubah">
							<a href="konsumen.php" class="btn btn-sm btn-danger"><b>Batal</b></a>
						</div>
					</div>
				</form><br>
