			  ...
			  <div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
						    ...
						    $no = 1;
						    $data = $conn->query("SELECT * FROM servis_header ORDER BY no_servis desc");
						    ...
						    while ($result = $data->fetch_assoc()){
						      ...
						      <tr>
						        ...
						        <td><font size="2"><?php echo "80/DK/".$result ['no_servis']; ?></td>
						        ...
						        <td><font size="2"><?php echo $result ['telp'] ; ?></td>
						        <td><font size="2"><?php echo $result ['tgl_terima'] ; ?></td>
						        <td><font size="2"><?php echo $result ['qty'] ; ?></td>
								<td><font size="2"><?php echo $result ['status'] ; ?></td>
						     
			
							    <td class="center">                                   
									
									<a class="btn btn-info" href="edit_transaksi.php?no=<?php echo $result ['no_servis'] ; ?>" title="Edit Data">
										<i class="halflings-icon white edit"></i></a> 

									<a class="btn btn-print" href="nota.php?no=<?php echo $result ['no_servis'] ; ?>" title="Print" target="_blank">
										<i class="halflings-icon white print"></i></a>                                          
										
									<a class="btn btn-success" href="../aksi/proses.php?no=<?php echo $result ['no_servis'] ; ?>" title="Ambil Barang">
										<i class="halflings-icon white edit"></i>Ambil</a> 
								</td>
