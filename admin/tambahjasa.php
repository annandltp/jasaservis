	...
	<!-- start: Header -->
		...
		<div class="row-fluid sortable">		
			...
			<div class="box-content">
			  	<form class="form-horizontal" action="../aksi/proses.php?kirimjasa" method="post">
			  		 <div class="form-group">
					    <label class="control-label col-sm-2" for="kd_jasa">Kode Jasa :</label>
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kd_jasa">
					    </div>
					  </div><br>
					  <div class="form-group">
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="submit" name="kirimjasa" class="btn btn-sm btn-info" value="tambah">
