		...
		<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Zoom Data</h2>
						<div class="box-icon">
			...
			<div class="box-content">
			  	<form class="form-horizontal" action="../aksi/proses.php?kirim" method="post">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nmbarang" value="<?php echo $row ['1']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nmpemilik" value="<?php echo $row ['2']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="alamat" value="<?php echo $row ['3']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="tlpn" value="<?php echo $row ['4']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kerusakan" value="<?php echo $row ['5']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kelengkapan" value="<?php echo $row ['6']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="penerimabarang" value="<?php echo $row ['8']; ?>" readonly>
					    </div>
					  </div><br>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="teknisi" value="<?php echo $row ['9']; ?>" readonly>
					    </div>
					  </div><br>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kondisibrg" value="<?php echo $row ['10']; ?>" readonly >
					    </div>
					  </div><br>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="date" class="form-control" name="tglambil" value="<?php echo $row ['11']; ?>" readonly >
					    </div>
					  </div><br>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="penyerahanbarang" value="<?php echo $row ['12']; ?>" readonly >
					    </div>
					  </div><br>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="biaya" value="<?php echo $row ['13']; ?>" readonly>
					    </div>
					  </div><br>
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<a href="dataservis.php" class="btn btn-sm btn-info"><b>Back</b></a>
						</div>
					</div>
				</form><br>
