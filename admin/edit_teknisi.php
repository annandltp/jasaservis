		...
		<div class="row-fluid sortable">		
				<div class="box span6">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Edit Data Teknisi</h2>
						<div class="box-icon">
			...
			<div class="box-content">
			  	<form class="form-horizontal" action="../aksi/teknisi_update.php?updateteknisi" method="post">
				  <div class="form-group">
					 ...
					 <div class="form-group">
					    <label class="control-label col-sm-2" for="kd_teknisi">Kode Teknisi :</label>
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kd_teknisi" value="<?php echo $row ['1']; ?>" readonly>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nm_teknisi" value="<?php echo $row ['2']; ?>" required>
					    </div>
					  </div><br>
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="submit" name="updateteknisi" class="btn btn-sm btn-info" value="Ubah">
