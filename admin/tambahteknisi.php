	...
	<!-- start: Header -->
		...
		<div class="row-fluid sortable">		
			...
			<div class="box-content">
			  	<form class="form-horizontal" action="../aksi/proses.php?kirimteknisi" method="post">
			  		 <div class="form-group">
					    <label class="control-label col-sm-2" for="kd_teknisi">Kode Teknisi :</label>
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kd_teknisi">
					    </div>
					  </div><br>
					  <div class="form-group">
					    <label class="control-label col-sm-2" for="nm_teknisi">Nama Teknisi :</label>
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nm_teknisi">
					    </div>
					  </div><br>
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="submit" name="kirimteknisi" class="btn btn-sm btn-info" value="tambah">
