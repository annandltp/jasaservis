						    ...
						    while ($result = $data->fetch_assoc()){
						      ...
						      <tr>
							    ...
							    <td class="center">
									...
									<a class="btn btn-danger" href="../aksi/hapus_servistek.php?no=<?php echo $result ['no'] ; ?>"onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"title="Hapus Data">
