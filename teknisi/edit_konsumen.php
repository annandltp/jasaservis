...
if (isset($_GET['kd_konsumen'])) {
	$data = $conn->prepare("SELECT * FROM konsumen WHERE kd_konsumen = ? ");
	$kd_konsumen = $_GET['kd_konsumen'];
	$data->bind_param('s', $kd_konsumen);
	$data->execute();
		...
		<div class="row-fluid sortable">		
			...
			<div class="box-content">
                  ...
                  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kd_konsumen" value="<?php echo $row ['0']; ?>" readonly>
					    </div>
					  </div><br>
					  <div class="form-group">
					    <label class="control-label col-sm-2" for="nm_konsumen">Nama Konsumen :</label>
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nm_konsumen" value="<?php echo $row ['1']; ?>" required>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="telepon" value="<?php echo $row ['2']; ?>" required>
					    </div>
					  </div><br>
