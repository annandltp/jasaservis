			  ...
			  <div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
						    ...
						    $kd_konsumen ='';
						    $data = $conn->query("SELECT * FROM konsumen ORDER BY kd_konsumen desc");
						    ...
						    while ($result = $data->fetch_assoc()){
						      ...
						      <tr>
							    ...
							    <td class="center">                                        
									<a class="btn btn-info" href="edit_konsumen.php?kd_konsumen=<?php echo $result ['kd_konsumen'] ; ?>" title="Edit Data Konsumen">
										<i class="halflings-icon white edit"></i>Ubah</a>                                           

									<a class="btn btn-danger" href="../aksi/proses.php?kd_konsumen=<?php echo $result ['kd_konsumen'] ; ?>"onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"title="Hapus Data">
										<i class="halflings-icon white trash"></i>Hapus</a> 		
